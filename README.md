...
- open_question - (contains files used to formulate the open question). 
...
-3_in_1_code_with_trained_classifier (Jupyter Source File (.ipynb)) - the same code provided for the final subbmition (just in .ipynb - .py in final subbmition) 
